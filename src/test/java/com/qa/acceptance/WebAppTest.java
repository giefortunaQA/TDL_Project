...
//		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("mySidepanel")));
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("createFormDiv")));
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("displayDivRead")));
		// THEN
